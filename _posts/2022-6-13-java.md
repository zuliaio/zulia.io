...
dependencies {
    implementation 'io.zulia:zulia-client:4.15.5'
...
```bash
dependencies {
    implementation 'io.zulia:zulia-ai:4.15.5'
}
```
...
|-------|-----------|----------|
| `E5_SMALL_V2` | 384 | Asymmetric search (query vs passage) |
| `ALL_MINILM_L6_V2` | 384 | General-purpose symmetric similarity |
| `PUBMEDBERT` | 768 | Biomedical/medical domain |
