...
dependencies {
    implementation 'io.zulia:zulia-client:4.13.0'
...
```bash
dependencies {
    implementation 'io.zulia:zulia-ai:4.13.0'
}
```
...
indexConfig.addFieldConfig(FieldConfigBuilder.createGeoPointTopLevel("lat", "lon").index().sort());
```
