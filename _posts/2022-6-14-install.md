...
```
cd YOUR_INSTALL_DIR
wget https://github.com/zuliaio/zuliasearch/releases/download/5.3.0/zulia-server-5.3.0.tar
tar xvf zulia-server-5.3.0.tar
rm zulia-server-5.3.0.tar
ln -s zulia-server-5.3.0 zulia-server
```
