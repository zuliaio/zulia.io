...
```
cd YOUR_INSTALL_DIR
wget https://github.com/zuliaio/zuliasearch/releases/download/2.7.1/zulia-server-2.7.1.tar
tar xvf zulia-server-2.7.1.tar
rm zulia-server-2.7.1.tar
ln -s zulia-server-2.7.1 zulia-server
```
