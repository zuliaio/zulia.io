...
```
cd YOUR_INSTALL_DIR
wget https://github.com/zuliaio/zuliasearch/releases/download/4.18.0/zulia-server-4.18.0.tar
tar xvf zulia-server-4.18.0.tar
rm zulia-server-4.18.0.tar
ln -s zulia-server-4.18.0 zulia-server
```
