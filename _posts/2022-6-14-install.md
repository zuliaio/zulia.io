...
```
cd YOUR_INSTALL_DIR
wget https://github.com/zuliaio/zuliasearch/releases/download/5.5.1/zulia-server-5.5.1.tar
tar xvf zulia-server-5.5.1.tar
rm zulia-server-5.5.1.tar
ln -s zulia-server-5.5.1 zulia-server
```
