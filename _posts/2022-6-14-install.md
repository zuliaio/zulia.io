...
```
cd YOUR_INSTALL_DIR
wget https://github.com/zuliaio/zuliasearch/releases/download/2.5.2/zulia-server-2.5.2.tar
tar xvf zulia-server-2.5.2.tar
rm zulia-server-2.5.2.tar
ln -s zulia-server-2.5.2 zulia-server
```
