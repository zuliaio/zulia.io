...
```json
{
  ...
  "details": {
    ...
    "cpuUsage": {
      ...
      "details": {
        "system": "12.50%",
        "systemAlertThreshold": "80.00%",
        "jvm": "3.20%",
        "jvmAlertThreshold": "90.00%",
        "numProcessors": 8
      }
    },
    "diskSpace": {
...
Health thresholds and optional MongoDB logging are configured in `zulia.yaml`. See the [Install]({% post_url 2022-6-14-install %}) page for the `health` configuration section.
